...
function SearchBox() {
    ...
    return (
        <div className="hidden md:flex flex-col w-[35%] relative">
            <div className="flex bg-blue-50 rounded-md border-blue-200 px-2 items-center">
                ...
                <input
                    ...
                    className="w-full p-2 text-sm text-black bg-inherit placeholder:text-blue-300 focus:outline-none"
                />
            </div>
