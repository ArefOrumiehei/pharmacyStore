    ...
    <footer className="bg-white border border-blue-100 text-gray-700 pt-6 rounded-t-lg overflow-hidden h-full">
      <div className="container mx-auto px-6 pb-6 pt-4 flex items-start justify-center flex-wrap gap-8 h-full">
        ...
        <div className="flex-2 px-6 pb-4">
          ...
          <div>
            <p className="text-justify leading-6.5 text-gray-600">ی سری توضیحات راجب داروخونه و اینکه چیشد ک چنین شد و اصن چرا و به چ دلیل ک ما اینجاییم و اخه ک چی بشه اصن تهش خب برای چی اصن؟ فلان بهمان و بیسار و تشکیلات  و اینکه از چ سالی داروخونه هستش و چیشد ک به اینجا رسید و موسس کیه و ما کی هستیم و اوتا کی هستنو و ازمون چی میخان.؟</p>
          </div>
        </div>
        
        <div className="flex-1 min-w-[100px]">
          <h3 className="text-lg font-semibold mb-4 text-blue-800">دسترسی سریع</h3>
          <ul className="space-y-4">
            <li><Link to="/" className="text-gray-600 hover:text-blue-800 transition">خانه</Link></li>
            <li><Link to="/aboutus" className="text-gray-600 hover:text-blue-800 transition">درباره ما</Link></li>
            <li><Link to="/contactus" className="text-gray-600 hover:text-blue-800 transition">تماس با ما</Link></li>
            <li><Link to="/faq" className="text-gray-600 hover:text-blue-800 transition">سوالات متداول</Link></li>
            <li><Link to="/terms" className="text-gray-600 hover:text-blue-800 transition">قوانین و مقررات</Link></li>
          </ul>
        </div>

        <div className="flex-1 min-w-[120px]">
          <h3 className="text-lg font-semibold mb-4 text-blue-800">خدمات مشتریان</h3>
          <ul className="space-y-4">
            <li><Link to="/" className="text-gray-600 hover:text-blue-800 transition">نحوه ثبت سفارش</Link></li>
            <li><Link to="/aboutus" className="text-gray-600 hover:text-blue-800 transition">پیگیری سفارش</Link></li>
            <li><Link to="/faq" className="text-gray-600 hover:text-blue-800 transition">شرایط بازگشت کالا</Link></li>
            <li><Link to="/faq" className="text-gray-600 hover:text-blue-800 transition">نحوه ارسال مرسولات</Link></li>
          </ul>
        </div>
        ...
        <div className="flex-1 flex items-start justify-between flex-col gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-600">کرج، فلان جا، بهمان جا، نبش خیابون فلان</span>
          </div>
        </div>
      </div>
