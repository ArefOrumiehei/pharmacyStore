...
import type { IAddressFormParams, IEditAddressFormParams } from "@/services/accountServices/accountServices";

// Components
import { AddressPanel, type FormState } from "./_components/addressPanel/AddressPanel";
...
export default function AddressStep() {
  ...
  if (syncing) {
    return (
      <div className="flex flex-col lg:flex-row gap-5 items-stretch lg:items-start" dir="rtl">
