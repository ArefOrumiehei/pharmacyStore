...
export default function Checkout() {
  ...
  if (isRedirecting) {
    return (
      <div className="w-full h-64 my-6 rounded-2xl bg-blue-50 border border-blue-100 flex flex-col items-center justify-center gap-4" dir="rtl">
  ...
  return (
    <div className="w-full max-w-2xl mx-auto py-8" dir="rtl">
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-gray-400 mt-1">اطلاعات دریافت سفارش را وارد کنید</p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
        ...
        <div className="bg-white border border-blue-100 rounded-2xl p-6 flex flex-col gap-4">
          ...
          <Field label="آدرس" error={errors.receiverAddress?.message} icon={IconMapPin}>
            <input
              ...
              <div className="flex flex-col gap-1.5">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-0.5">
                      {image.name ? "برای تغییر کلیک کنید" : "PNG, JPG تا ۵ مگابایت"}
                    </p>
                  </div>
                </div>
                <input
                ...
                {errors.paymentReceiptPic && (
                  <p className="text-rose-500 text-xs">{errors.paymentReceiptPic.message as string}</p>
                )}
              </div>
            </div>
          )}
