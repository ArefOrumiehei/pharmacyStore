            ...
            <div className="flex items-start justify-between flex-col min-[260px]:flex-row gap-2 sm:gap-3">
                <div className="flex flex-col gap-0.5 sm:gap-1 min-w-0">
                    <div className="flex items-center gap-1 sm:gap-1.5">
                        <IconHash
                            size={11}
                            className="text-gray-300 flex-shrink-0 sm:w-3 sm:h-3"
                        />
                        <span className="text-[10px] sm:text-xs font-mono text-gray-400 truncate">
                            {ticket.trackingCode}
                        </span>
                    </div>
                ...
                <span
                    className={`flex items-center gap-1 text-[10px] sm:text-xs font-semibold px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-lg border flex-shrink-0 whitespace-nowrap ${status.className}`}
                >
            ...
            <div className="flex items-center justify-between max-[360px]:flex-col max-[360px]:items-start gap-2 text-[10px] sm:text-xs text-gray-400">
                <span className="flex items-center gap-1 min-w-0 truncate">
                    ...
                    <span dir="ltr" className="truncate">
                        {toPersianDigits(ticket.creationDate)}
                    </span>
                </span>
                {ticket.adminReplyDate && (
                    <span className="flex items-center gap-1 min-w-0 truncate flex-shrink-0">
                        ...
                        پاسخ:{" "}
                        <span dir="ltr" className="truncate">
                            {toPersianDigits(ticket.adminReplyDate)}
                        </span>
                    </span>
                )}
            </div>
