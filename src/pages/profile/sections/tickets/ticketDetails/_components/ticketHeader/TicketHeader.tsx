  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      <div className="min-w-0 flex-1">
        <h2 className="text-sm sm:text-base font-bold text-blue-800 truncate">{ticket.subject}</h2>
        <div className="flex items-center gap-2 mt-0.5">
          <IconHash size={12} className="text-gray-400 flex-shrink-0" />
          <span className="text-xs font-mono text-gray-400 truncate">{ticket.trackingCode}</span>
        </div>
      </div>
