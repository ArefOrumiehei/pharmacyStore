        ...
        <div className="flex items-center justify-between gap-2 sm:gap-3 flex-wrap">
            <div className="flex items-center gap-2 sm:gap-3">
                ...
                >
                    <IconArrowRight
                        size={15}
                        className="text-blue-800 sm:w-[17px] sm:h-[17px]"
                    />
                </button>
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
                <span
                    className={`flex items-center gap-1 sm:gap-1.5 text-[10px] sm:text-xs font-semibold px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-lg sm:rounded-xl border whitespace-nowrap ${s.class}`}
                >
