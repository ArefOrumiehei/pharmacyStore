...
export const accountKeys = {
  ...
  address: (addressId: number) => [...accountKeys.addresses(), addressId] as const,
...
async function fetchListOrEmpty<T>(fetcher: () => Promise<IApiResponse<T[]>>): Promise<T[]> {
  try {
...
export const useUserOrderQuery = (orderId: number | undefined, options?: QueryOpts<IOrder>) =>
  useQuery({
...
export const useTicketDetailsQuery = (ticketId: string | undefined, options?: QueryOpts<ITicket>) =>
  useQuery({
...
export const useUserAddressQuery = (addressId: number | undefined, options?: QueryOpts<IAddress>) =>
  useQuery({
...
export const useUpdateProfileMutation = (options?: MutationOpts<IApiResponse<IUserProfile>, IUpdateProfileParams>) => {
...
export const useCompleteProfileMutation = (options?: MutationOpts<IApiResponse<IUserProfile>, ICompleteProfileParams>) => {
  const queryClient = useQueryClient();
  return useMutation({
    ...options,
...
export const useChangePasswordMutation = (options?: MutationOpts<IApiResponse, IChangePasswordParams>) => {
  return useMutation({
    ...options,
...
export const useSetPasswordMutation = (options?: MutationOpts<IApiResponse, ISetPasswordParams>) => {
  const queryClient = useQueryClient();
  return useMutation({
    ...options,
...
export const useChangeMobileRequestOtpMutation = (options?: MutationOpts<IApiResponse, IChangeMobileRequestParams>) => {
  return useMutation({
    ...options,
...
export const useChangeMobileVerifyMutation = (options?: MutationOpts<IApiResponse, IChangeMobileVerifyParams>) => {
  const queryClient = useQueryClient();
  return useMutation({
    ...options,
...
export const useCreateUserAddressMutation = (options?: MutationOpts<IApiResponse, IAddressFormParams>) => {
  const queryClient = useQueryClient();
  return useMutation({
    ...options,
...
export const useEditUserAddressMutation = (options?: MutationOpts<IApiResponse, IEditAddressFormParams>) => {
  const queryClient = useQueryClient();
  return useMutation({
    ...options,
    ...
    onSuccess: (res, variables, ...rest) => {
      ...
      queryClient.invalidateQueries({ queryKey: accountKeys.addresses() });
      queryClient.invalidateQueries({ queryKey: accountKeys.address(Number(variables.id)) });
      (options?.onSuccess as AnyCallback | undefined)?.(res, variables, ...rest);
    },
    onError: (err, variables, ...rest) => {
...
export const useDeleteUserAddressMutation = (options?: MutationOpts<IApiResponse, number>) => {
  const queryClient = useQueryClient();
  return useMutation({
    ...options,
...
export const useRequestReturnMutation = (options?: MutationOpts<IApiResponse, IRequestReturnParams>) => {
  const queryClient = useQueryClient();
  return useMutation({
    ...options,
    ...
    onSuccess: (res, variables, ...rest) => {
      ...
      queryClient.invalidateQueries({ queryKey: accountKeys.order(variables.orderId) });
